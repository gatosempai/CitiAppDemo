...
public class RetrofitFragment extends Fragment {
  ...
  public void onListContributorsWithFullUserInfoClicked() {
    ...
    _disposables.add(
        _githubService
            .contributors(_username.getText().toString(), _repo.getText().toString())
            .flatMap(new Function<List<Contributor>, ObservableSource<? extends Contributor>>() {
              @Override
              public ObservableSource<? extends Contributor> apply(List<Contributor> source) throws Exception {

...
public class GetClientNameRepository implements GetClientNameDataRepository {
    ...
    @Inject
    GetClientNameRepository() {}


    @Override
    public Single<GetClientNameResponse> getClientName(GetClientNameRequest request) {
        ...
        fields.put("clientNumber", request.getClientNumber());
        fields.put("vRelease", "R4");
        fields.put("RSA_mobileSDK", "{\"TIMESTAMP\": \"2018-08-29T03:15:52Z\",\n" +
                "\"HardwareID\": \"-1\",\n" +
                "\"SIM_ID\": \"-1\",\n" +
                "\"PhoneNumber\": \"-1\",\n" +
